...
function BetInner() {
  ...
  return (
    <div className="wrap">
      ...
      <p className="eyebrow">You&rsquo;ve been challenged — at the verified fair price</p>
      <div className="card chal">
        ...
        <div className="row"><span className="k">You take</span><span className="v">NO — it doesn&rsquo;t happen</span></div>
          ...
          <div className="card">
            ...
            {result && (
              <div className="proofbox" style={{ marginTop: 12 }}>
                ...
                {result.score && <>score : {result.score.home}–{result.score.away} · corners {result.corners}<br /></>}
      ...
      <p className="foot">Signed by both wallets · anchored on Solana ·<br />settled by TxLINE verified data. No bookmaker.</p>
    </div>
  );
}
